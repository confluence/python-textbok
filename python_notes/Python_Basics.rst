...
.. Todo:: removed learning objectives; possibly they should be added to all the chapters.  Move the bit about being able to run code, etc. to end of next subsection.
...
.. Todo:: translate the section about compiling programs. Say something about how to use the interactive interpreter.  Include something about an IDE (Wing?).
